...
<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" id="name" value="{{ old('name', isset($assetCategory->name) ? $assetCategory->name : null) }}" minlength="1" maxlength="255" required="true" placeholder="Enter name here...">
