              ...
              <tbody class="tbody-custom">
                <tr>
                  <td>
                    ...
                    <center data-parsed=""> <img src="{{ asset('app-assets/images/custom-images/ticket-inprogress.png') }}" alt="" align="center" class="float-center"> </center>
                    <table class="spacer">
                      <tbody>
                        <tr>
                          <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                ...
                                <th>
                                  <p class="text-center"> 
                                    ...
                                    @foreach ($tickets as $ticket)
                                      ...
                                      @if (Auth::user()->email === $ticket->email)
                                         <div><p class="text-center">{{ $ticket->description }}</p></div>
                                      @endif
