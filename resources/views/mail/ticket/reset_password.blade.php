...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/foundation-emails.css') }}">
                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <h4 class="text-center">Pirate Retirement Services</h4> </th>
                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <a href="{{ route('auth.password.email') }}"><h1 class="text-center">Forgot Your Password?</h1></a>
                                  <table class="spacer">
                                    <tbody>
                                      <tr>
                                        <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
