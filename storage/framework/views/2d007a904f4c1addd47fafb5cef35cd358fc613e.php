...
<html lang="<?php echo e(app()->getLocale()); ?>" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo e(asset('app-assets/images/ico/apple-icon-152.png')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('app-assets/images/ico/favicon.ico')); ?>">
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('app-assets/images/ico/favicon-32.png')); ?>">
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="#" class="navbar-brand nav-link"><img alt="branding logo" src="<?php echo e(asset('app-assets/images/logo/robust-logo-light.png')); ?>" data-expand="<?php echo e(asset('app-assets/images/logo/robust-logo-light.png')); ?>" data-collapse="<?php echo e(asset('app-assets/images/logo/robust-logo-small.png')); ?>" class="brand-logo"></a></li>
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo e(asset('app-assets/images/portrait/small/avatar-s-1.png')); ?>" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?php echo e(asset('app-assets/images/portrait/small/avatar-s-2.png')); ?>" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo e(asset('app-assets/images/portrait/small/avatar-s-3.png')); ?>" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?php echo e(asset('app-assets/images/portrait/small/avatar-s-6.png')); ?>" alt="avatar"><i></i></span></div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?php echo e(asset('')); ?>app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name"> <?php echo e(Auth::user()->name); ?></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a><a href="#" class="dropdown-item"><i class="icon-mail6"></i> My Inbox</a><a href="#" class="dropdown-item"><i class="icon-clipboard2"></i> Task</a><a href="#" class="dropdown-item"><i class="icon-calendar5"></i> Calender</a>
                  <div class="dropdown-divider"></div><a href="<?php echo e(route('logout')); ?>" class="dropdown-item" 
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-ticket"></i><span data-i18n="nav.project.main" class="menu-title">Ticket</span></a>
            <ul class="menu-content">
              <li><a href="<?php echo e(route('tickets.tickets.index')); ?>" data-i18n="nav.invoice.invoice_template" class="menu-item"><i class="icon-plus-square"></i><span data-i18n="nav.project.main" class="menu-title">
              </span>All Tickets</a>
              </li></ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="icon-briefcase3"></i><span data-i18n="nav.project.main" class="menu-title">Project</span></a>
              <ul class="menu-content">
                <li><a href="<?php echo e(route('projects.project.index')); ?>" data-i18n="nav.invoice.invoice_template" class="menu-item"><i class="icon-plus-square"></i><span data-i18n="nav.project.main" class="menu-title">
                </span>All Project</a>
                </li></ul>
              </li>
            ...
            <ul class="menu-content">
              <li><a href="<?php echo e(route('asset_categories.asset_category.index')); ?>" data-i18n="nav.invoice.invoice_template" class="menu-item"><i class="icon-plus-square"></i><span data-i18n="nav.project.main" class="menu-title">
              </span>All Assets</a>
              </li></ul>
            </li>
