                    ...
                    <div class="card-block">
                        ...
                        <div class="card-text">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                <?php echo Form::hidden('project_id', Auth::user()->id, array('placeholder' => 'Assigned by','class' => 'form-control','data-toggle="tooltip"', 'data-trigger="hover" data-placement="top" data-title="Assigned By"')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo Form::select('status',['open'=>'open','cancelled'=>'cancelled','on hold'=>'on hold','in progress'=>'in progress'], 'open', array('placeholder' => '','class' => 'form-control square','data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Status"')); ?>
                                ...
                                <div class=" row col col-md-12"><?php echo Form::label('watchers', 'Watchers', ['class' => 'form-label']); ?></div>
