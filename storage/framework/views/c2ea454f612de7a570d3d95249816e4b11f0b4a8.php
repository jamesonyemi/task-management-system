...
<html lang="<?php echo e(app()->getLocale()); ?>" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    <script src="<?php echo e(asset('app-assets/vendors/js/datetime/moment-with-locales.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('app-assets/vendors/js/datetime/bootstrap-datetimepicker.js')); ?>" type="text/javascript"></script>
