    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1 box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
            ...
            <div class="card-body collapse in"> 
                    ...
                    <form class="form-horizontal form-simple" method="POST"  action="<?php echo e(route('register')); ?>" >
                       <?php echo e(csrf_field()); ?>
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-1<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="name" value="<?php echo e(old('name')); ?>" placeholder="User Name" required autofocus>
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-1<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            <input type="email" class="form-control form-control-lg input-lg" id="user-email"  name="email" value="<?php echo e(old('email')); ?>" placeholder="Your Email Address" required>
                            <div class="form-control-position">
                ...
                <p class="text-xs-center">Already have an account ? <a href="<?php echo e(route('login')); ?>" class="card-link">Login</a></p>
            </div>
        </div>
      </div>
    </section>
